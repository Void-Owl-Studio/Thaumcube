...
public sealed class BlockRegistry
{
    ...
    public BlockRegistry()
    {
        ...
        Register(new BlockDefinition(BlockType.Water, "Water", false, true, false, BlockTextureAtlas.Water, BlockTextureAtlas.Water, BlockTextureAtlas.Water, new Vector3(0.16f, 0.32f, 0.58f), new MagicalProperties(0.10f, 0, 0.9f, "Flow")));
