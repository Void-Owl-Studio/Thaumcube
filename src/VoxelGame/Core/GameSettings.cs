...
public sealed class GameSettings
{
    ...
    public int MaxRenderDistanceChunks { get; init; } = 12;
    ...
    public float CloudHeightBlocks { get; init; } = 117f;
    public float CloudPlaneWidthBlocks { get; init; } = 768f;
    public float CloudPlaneDepthBlocks { get; init; } = 768f;
    public float CloudTextureScaleBlocks { get; init; } = 96f;
    public float CloudOpacity { get; init; } = 0.92f;
    public Vector3 CloudColor { get; init; } = Vector3.One;
    public float CloudSpeed { get; init; } = 0.006f;
    public Vector2 CloudDirection { get; init; } = Vector2.UnitX;
    public float CloudExtrusionHeightBlocks { get; init; } = 4f;
    public float CloudBlockSize { get; init; } = 6f;
    public float CloudBrightnessThreshold { get; init; } = 0.5f;
